...
export function MembersInvitesTable({
    ...
    () => [
      {
        ...
        cell: ({ row }) => {
            ...
            return (
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <div className="text-xs text-[var(--text-quiet)]">
                    {display.secondary}
                  </div>
                </div>
              </div>
          ...
          return (
            <div className="flex items-center gap-3">
              <div className="flex h-9 w-9 items-center justify-center rounded-lg bg-slate-200 text-xs font-semibold text-[var(--text-muted)]">
  ...
  return (
    <DataTable
      ...
      headerClassName="bg-[var(--surface-muted)] text-[11px] uppercase tracking-wide text-[var(--text-quiet)]"
