    ...
    >
      <div className="space-y-5">
        <div className="rounded-xl border border-[var(--border)] bg-[var(--surface-muted)]/40 p-4">
            ...
            <div className="space-y-2">
              <div className="flex items-center justify-between gap-2">
                ...
                <button
                  ...
                  className="text-xs font-medium text-[var(--text-quiet)] underline underline-offset-2 transition hover:text-[var(--text-muted)] disabled:cursor-not-allowed disabled:opacity-50"
          ...
          <p className="mt-2 text-xs text-[var(--text-quiet)]">
