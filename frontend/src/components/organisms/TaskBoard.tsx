...
const columns: Array<{
...
}> = [
  {
    ...
    text: "group-hover:text-[var(--text-muted)] text-[var(--text-quiet)]",
  ...
  },
  {
    ...
    status: "in_progress",
    dot: "bg-purple-500",
    accent: "hover:border-purple-500/40 hover:bg-purple-500/10",
    text: "group-hover:text-purple-400 text-[var(--text-quiet)]",
  ...
  },
  {
    ...
    status: "review",
    dot: "bg-indigo-500",
    accent: "hover:border-indigo-500/40 hover:bg-indigo-500/10",
    text: "group-hover:text-indigo-400 text-[var(--text-quiet)]",
  ...
  },
  {
    ...
    status: "done",
    dot: "bg-green-500",
    accent: "hover:border-green-500/40 hover:bg-green-500/10",
    text: "group-hover:text-green-400 text-[var(--text-quiet)]",
          ...
          >
            <div className="column-header z-10 rounded-t-xl border border-b-0 border-[var(--border)] bg-[var(--surface)] px-4 py-3 sm:sticky sm:top-0 sm:bg-[var(--surface)]/80 sm:backdrop-blur">
              ...
              {column.status === "review" && reviewCounts ? (
                <div className="mt-2 flex flex-wrap items-center gap-2 text-[10px] font-semibold uppercase tracking-wide text-[var(--text-quiet)]">
                  {(
                    [
                    ...
                    <button
                      ...
                      className={cn(
                        ...
                        reviewBucket === option.key
                          ...
                          : "border-[var(--border)] bg-[var(--surface)] text-[var(--text-muted)] hover:border-slate-300 hover:bg-[var(--surface-muted)]",
                      )}
