  ...
  <div className="border-b border-slate-200 p-2" cmdk-input-wrapper="">
    <div className="relative">
      ...
      <CommandPrimitive.Input
        ref={ref}
        className={cn(
          "w-full rounded-md border border-slate-300 bg-[var(--surface)] py-2 pl-8 pr-3 text-sm text-slate-900 placeholder:text-slate-500 focus:border-transparent focus:outline-none focus:ring-2 focus:ring-slate-400 disabled:cursor-not-allowed disabled:opacity-50",
          className,
        )}
        {...props}
      />
