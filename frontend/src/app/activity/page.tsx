          ...
          <div className="min-w-0">
            {item.context_href ? (
              <Link
                ...
                className="block text-sm font-semibold leading-snug text-[var(--text)] transition hover:text-slate-950 hover:underline"
                title={item.title}
                style={{
                  display: "-webkit-box",
                  WebkitLineClamp: 2,
            ...
            <div className="mt-1 flex flex-wrap items-center gap-x-2 gap-y-1 text-[11px] text-[var(--text-quiet)]">
              ...
              {item.actor_role ? (
                <>
                  <span className="text-slate-300">·</span>
                  <span className="text-[var(--text-quiet)]">{item.actor_role}</span>
                </>
              ) : null}
              <span className="text-slate-300">·</span>
