...
const liveFeedEventPillClass = (eventType: LiveFeedEventType): string => {
  ...
  if (eventType === "agent.offline") {
    return "border-slate-300 bg-[var(--surface-muted)] text-[var(--text-muted)]";
  }
...
const TaskCommentCard = memo(function TaskCommentCard({
  ...
  return (
    ...
    >
      <div className="flex items-center justify-between text-xs text-[var(--text-quiet)]">
    ...
    >
      <div className="flex items-start gap-3">
        ...
        <div className="min-w-0 flex-1">
          ...
          <div className="mt-1 flex flex-wrap items-center gap-x-2 gap-y-1 text-[11px] text-[var(--text-quiet)]">
            <span
              className={cn(
            ...
            {authorRole ? (
              <>
                ...
                <span className="text-[var(--text-quiet)]">{authorRole}</span>
              </>
            ) : null}
            <span className="text-slate-300">·</span>
      ...
      {message ? (
        ...
        <p className="mt-3 text-sm text-[var(--text-quiet)]">—</p>
      )}
    </div>
  );
});
    ...
    <DashboardShell>
      ...
      <SignedIn>
        ...
        >
                ...
                <div className="flex flex-wrap items-center gap-3">
                    ...
                    <button
                      className={cn(
                        ...
                        viewMode === "board"
                          ...
                          : "text-[var(--text-muted)] hover:bg-slate-200 hover:text-[var(--text)]",
                      )}
                  ...
                  {isOrgAdmin ? (
                    <button
                      ...
                      className="inline-flex h-9 w-9 items-center justify-center rounded-lg border border-[var(--border)] text-[var(--text-muted)] transition hover:border-slate-300 hover:bg-[var(--surface-muted)]"
          ...
          <div className="relative flex flex-col gap-4 p-4 md:flex-row md:gap-6 md:p-6">
            {isOrgAdmin ? (
              <aside className="flex w-full flex-col rounded-xl border border-[var(--border)] bg-[var(--surface)] shadow-sm md:h-full md:w-64">
                <div className="flex items-center justify-between border-b border-[var(--border)] px-4 py-3">
                  ...
                  <button
                    ...
                    className="rounded-md border border-[var(--border)] px-2.5 py-1 text-xs font-semibold text-[var(--text-muted)] transition hover:border-slate-300 hover:bg-[var(--surface-muted)]"
                  >
                    Add
                  </button>
                </div>
                <div className="flex-1 space-y-2 overflow-y-auto p-3">
                  {sortedAgents.length === 0 ? (
                    <div className="rounded-lg border border-dashed border-[var(--border)] p-3 text-xs text-[var(--text-quiet)]">
                    ...
                    sortedAgents.map((agent) => {
                      ...
                      return (
                        <button
                          ...
                          type="button"
                          className={cn(
                            "flex w-full items-center gap-3 rounded-lg border border-transparent px-2 py-2 text-left transition hover:border-[var(--border)] hover:bg-[var(--surface-muted)]",
                          )}
            ...
            <div className="min-w-0 flex-1 space-y-6">
              ...
              {isLoading ? (
                <div className="flex min-h-[50vh] items-center justify-center text-sm text-[var(--text-quiet)]">
                  Loading {titleLabel}…
                </div>
              ) : (
                <>
                        ...
                        <div className="rounded-xl border border-[var(--border)] bg-[var(--surface)] shadow-sm">
                            ...
                            <div className="flex flex-wrap items-center justify-between gap-3">
                              <div className="min-w-0">
                                ...
                                {groupSnapshot.group.description ? (
                                  <p className="mt-1 max-w-3xl text-xs text-[var(--text-quiet)] line-clamp-2">
                                    {groupSnapshot.group.description}
                                  </p>
                                ) : null}
                              </div>
                          ...
                          <div className="px-5 py-4">
                            ...
                            groupSnapshot.boards.length ? (
                              <div className="grid gap-4 md:grid-cols-2">
                                {groupSnapshot.boards.map((item) => (
                                  ...
                                  >
                                    ...
                                    >
                                      <div className="min-w-0">
                                        <p className="truncate text-sm font-semibold text-[var(--text)] group-hover:text-blue-600">
                                          {item.board.name}
                                        </p>
                                      ...
                                      <ArrowUpRight className="mt-0.5 h-4 w-4 flex-shrink-0 text-[var(--text-quiet)] group-hover:text-blue-600" />
                                    </button>
                                    ...
                                    {item.tasks && item.tasks.length ? (
                                      <ul className="mt-3 space-y-2">
                                        ...
                                        {item.tasks.length > 3 ? (
                                          <li className="text-xs text-[var(--text-quiet)]">
                                            +{item.tasks.length - 3} more…
                                          </li>
                                        ) : null}
                                      </ul>
                                    ) : (
                                      <p className="mt-3 text-sm text-[var(--text-quiet)]">
                              ...
                              <p className="text-sm text-[var(--text-quiet)]">
                  ...
                  {viewMode === "board" ? (
                    ...
                    <div className="rounded-xl border border-[var(--border)] bg-[var(--surface)] shadow-sm">
                      ...
                      <div className="divide-y divide-[var(--border)]">
                        {tasks.length === 0 ? (
                          <div className="px-5 py-8 text-sm text-[var(--text-quiet)]">
                          ...
                          tasks.map((task) => (
                            ...
                            >
                              <div className="flex flex-wrap items-center justify-between gap-3">
                                ...
                                <div className="flex flex-wrap items-center gap-3 text-xs text-[var(--text-quiet)]">
                                  {task.approvals_pending_count ? (
      ...
      >
        <div className="flex h-full flex-col">
          <div className="flex items-center justify-between border-b border-[var(--border)] px-4 py-3 md:px-6 md:py-4">
            <div>
              <p className="text-xs font-semibold uppercase tracking-wider text-[var(--text-quiet)]">
                Task detail
              </p>
            ...
            <div className="flex items-center gap-2">
              <button
                ...
                className="rounded-lg border border-[var(--border)] p-2 text-[var(--text-quiet)] transition hover:bg-[var(--surface-muted)]"
          ...
          <div className="flex-1 space-y-6 overflow-y-auto px-6 py-5">
            ...
            <div className="space-y-2">
              ...
              {customFieldDefinitionsQuery.isLoading ? (
                <p className="text-sm text-[var(--text-quiet)]">Loading custom fields…</p>
                ...
                <p className="text-sm text-[var(--text-quiet)]">No custom fields.</p>
              )}
            </div>
            <div className="space-y-2">
              <p className="text-xs font-semibold uppercase tracking-wider text-[var(--text-quiet)]">
              ...
              {selectedTask?.tags?.length ? (
                ...
                <p className="text-sm text-[var(--text-quiet)]">No tags assigned.</p>
              )}
            </div>
            <div className="space-y-2">
              <p className="text-xs font-semibold uppercase tracking-wider text-[var(--text-quiet)]">
            ...
            <div className="space-y-3">
              ...
              {approvalsError ? (
                <div className="rounded-lg border border-[var(--border)] bg-[var(--surface-muted)] p-3 text-xs text-[var(--text-quiet)]">
                  {approvalsError}
                </div>
              ) : isApprovalsLoading ? (
                <p className="text-sm text-[var(--text-quiet)]">Loading approvals…</p>
                ...
                <div className="space-y-3">
                  {taskApprovals.map((approval) => (
                    ...
                    >
                      <div className="flex flex-wrap items-start justify-between gap-2 text-xs text-[var(--text-quiet)]">
                        <div>
                          <p className="text-xs font-semibold uppercase tracking-wider text-[var(--text-quiet)]">
                      ...
                      {approval.status === "pending" ? (
                        <div className="mt-3 flex flex-wrap gap-2">
                          ...
                          <Button
                            ...
                            className="border-slate-300 text-[var(--text-muted)]"
                          >
                            Reject
                          </Button>
                        </div>
            ...
            <div className="space-y-3">
              ...
              {isCommentsLoading ? (
                <p className="text-sm text-[var(--text-quiet)]">Loading comments…</p>
              ) : commentsError ? (
                <div className="rounded-lg border border-[var(--border)] bg-[var(--surface-muted)] p-3 text-xs text-[var(--text-quiet)]">
                  {commentsError}
                </div>
              ) : comments.length === 0 ? (
                <p className="text-sm text-[var(--text-quiet)]">No comments yet.</p>
              ) : (
                <div className="space-y-3">
      ...
      <aside
        className={cn(
          "fixed right-0 top-0 z-50 h-full w-full max-w-[96vw] transform border-l border-[var(--border)] bg-[var(--surface)] shadow-2xl transition-transform md:w-[560px]",
      ...
      <aside
        className={cn(
          "fixed right-0 top-0 z-50 h-full w-full max-w-[96vw] transform border-l border-[var(--border)] bg-[var(--surface)] shadow-2xl transition-transform md:w-[520px]",
        ...
        <div className="flex h-full flex-col">
          ...
          <div className="flex-1 overflow-y-auto px-6 py-4">
            {isLiveFeedHistoryLoading && orderedLiveFeed.length === 0 ? (
              <p className="text-sm text-[var(--text-quiet)]">Loading feed…</p>
      ...
      <Dialog open={isEditDialogOpen} onOpenChange={setIsEditDialogOpen}>
        <DialogContent aria-label="Edit task">
          ...
          <div className="space-y-4">
            <div className="space-y-2">
              <label className="text-xs font-semibold uppercase tracking-wider text-[var(--text-quiet)]">
                Title
              </label>
              <Input
                value={editTitle}
            ...
            <div className="space-y-2">
              <div className="flex items-center justify-between gap-2">
                ...
                <button
                  ...
                  className="text-xs font-medium text-[var(--text-quiet)] underline underline-offset-2 transition hover:text-[var(--text-muted)]"
                >
                  Manage tags
                </button>
              </div>
              ...
              />
              {editTagIds.length === 0 ? (
                <p className="text-xs text-[var(--text-quiet)]">No tags assigned.</p>
              ) : (
                <div className="flex flex-wrap gap-2">
                  {editTagIds.map((tagId) => {
                    ...
                    return (
                      <span
                        key={tagId}
                        className="inline-flex items-center gap-1.5 rounded-full border border-[var(--border)] bg-[var(--surface-muted)] px-3 py-1 text-xs text-[var(--text-muted)]"
                      >
                        <span
                          className="h-1.5 w-1.5 rounded-full"
                        ...
                        <button
                          ...
                          className={cn(
                            "rounded-full p-0.5 text-[var(--text-quiet)] transition",
                            canWrite
            ...
            <div className="space-y-2">
              ...
              {editDependsOnTaskIds.length === 0 ? (
                <p className="text-xs text-[var(--text-quiet)]">No dependencies.</p>
              ) : (
                <div className="flex flex-wrap gap-2">
                    ...
                    return (
                      ...
                      >
                        ...
                        <button
                          ...
                          className="rounded-full p-0.5 text-[var(--text-quiet)] transition hover:bg-[var(--surface)] hover:text-[var(--text-muted)]"
                          aria-label="Remove tag"
                          disabled={!canWrite || isCreating}
                        >
                          <X className="h-3 w-3" />
