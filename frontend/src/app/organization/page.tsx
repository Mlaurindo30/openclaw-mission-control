  ...
  return (
    <div className="space-y-3">
          ...
          <button
            ...
            className={cn(
              ...
              scope === "all"
                ...
                : "text-[var(--text-quiet)] hover:text-[var(--text-muted)]",
            )}
      ...
      {scope === "all" ? (
        ...
        <div>
          {boards.length === 0 ? (
            <div className="rounded-xl border border-[var(--border)] bg-[var(--surface-muted)] px-4 py-3 text-sm text-[var(--text-quiet)]">
            ...
            <div className="px-4 py-4 md:px-8 md:py-6">
              <div className="flex flex-wrap items-center justify-between gap-6">
                <div>
                  ...
                  <div className="mt-3 flex flex-wrap items-center gap-4 text-xs text-[var(--text-quiet)]">
                    <span>
